...
set "PYTHON_EMBED_URL=https://www.python.org/ftp/python/3.13.0/python-3.13.0-embed-amd64.zip"
set "PYTHON_ZIP=%PORTABLE_DIR%\python-embed.zip"
set "UV_URL=https://github.com/astral-sh/uv/releases/download/0.4.17/uv-x86_64-pc-windows-msvc.zip"
set "UV_ZIP=%PORTABLE_DIR%\uv.zip"
set "GIT_URL=https://github.com/git-for-windows/git/releases/download/v2.48.1.windows.1/PortableGit-2.48.1-64-bit.7z.exe"
