...
class ModelsProcessor(QtCore.QObject):
    ...
    def apply_facerestorer(self, swapped_face_upscaled, restorer_det_type, restorer_type, restorer_blend, fidelity_weight, detect_score, target_kps):
        return self.face_restorers.apply_facerestorer(swapped_face_upscaled, restorer_det_type, restorer_type, restorer_blend, fidelity_weight, detect_score, target_kps)
    ...
    def process_masks_and_masks(self, swap_restorecalc, original_face_512, parameters, control):
        return self.face_masks.process_masks_and_masks(swap_restorecalc, original_face_512, parameters, control)
