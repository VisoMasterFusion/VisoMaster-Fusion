...
class FaceRestorers:
    ...
    def run_ref_ldm_unet(self,
        ...
        for onnx_kv_name, expected_shape in onnx_kv_input_names_to_shape.items():
            ...
            io_binding.bind_input(name=onnx_kv_name, device_type=bind_device_type, device_id=bind_device_id, element_type=np.float32, shape=tuple(tensor_to_bind.shape), buffer_ptr=tensor_to_bind.data_ptr())
