...
class FunctionWorker:
    ...
    def apply_denoiser_unet(
        ...
        return self.face_denoiser.apply_denoiser_unet(
            image_cxhxw_uint8=image_cxhxw_uint8,
            reference_kv_map=reference_kv_map,
            use_reference_exclusive_path=use_reference_exclusive_path,
            denoiser_mode=denoiser_mode,
            denoiser_single_step_t=denoiser_single_step_t,
            denoiser_ddim_steps=denoiser_ddim_steps,
            denoiser_cfg_scale=denoiser_cfg_scale,
            denoiser_ddim_eta=denoiser_ddim_eta,
            base_seed=base_seed,
            latent_sharpening_strength=latent_sharpening_strength,
            enable_color_correction=enable_color_correction,
            color_mask=color_mask,
            coarse_grain_reduction=coarse_grain_reduction,
            micro_grain_strength=micro_grain_strength,
        )
