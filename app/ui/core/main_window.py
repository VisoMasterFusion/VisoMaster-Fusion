...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon10a = QIcon()
        icon10a.addFile(u":/media/media/theatre_hover.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.theatreModeButton.setIcon(icon10a)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.theatreModeCheckBox.setText(QCoreApplication.translate("MainWindow", u"Theatre Mode", None))
