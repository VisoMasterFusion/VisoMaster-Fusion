...
SETTINGS_LAYOUT_DATA: Any = {
    ...
    "Misc": {
        ...
        "AutoLoadTargetFolderToggle": {
            "level": 1,
            "label": "Auto-load Target Folder Files",
            "default": False,
            "help": "Watch the configured Target media folder and automatically add new image/video files to the list.",
            "exec_function": control_actions.handle_auto_load_target_folder_toggle,
            "exec_function_args": [],
        },
        "AutoLoadTargetFolderRecursiveToggle": {
            ...
            "default": False,
            "parentToggle": "AutoLoadTargetFolderToggle",
            "requiredToggleValue": True,
            "help": "When auto-loading the Target Videos folder, also watch and import files from subfolders.",
            "exec_function": control_actions.handle_auto_load_target_folder_toggle,
            "exec_function_args": [],
        },
