...
DENOISER_LAYOUT_DATA: Any = {
    "ReF-LDM Denoiser": {
        ...
        "DenoiserCoarseGrainReductionToggle": {
            "level": 1,
            "widget_type": "ToggleButton",
            "label": "Coarse Grain Suppression",
            "control_name": "DenoiserCoarseGrainReductionToggle",
            "default": True,
            "help": "Suppresses 8x8 VAE block artifacts and macro-grain by anchoring diffusion latents to the input face.",
        },
        "DenoiserCoarseGrainAmountDecimalSlider": {
            "level": 2,
            "widget_type": "ParameterDecimalSlider",
            "label": "Grain Reduction Amount",
            "control_name": "DenoiserCoarseGrainAmountDecimalSlider",
            "min_value": "0.0",
            "max_value": "1.0",
            "default": "0.85",
            "step": 0.05,
            "decimals": 2,
            "parentToggle": "DenoiserCoarseGrainReductionToggle",
            "requiredToggleValue": True,
            "help": "Controls the strength of coarse grain reduction. 0.0 retains original noise; 1.0 maximally suppresses 8x8 blockiness.",
        },
        "DenoiserMicroGrainToggle": {
            "level": 1,
            "widget_type": "ToggleButton",
            "label": "Sub-Pixel Micro Grain",
            "control_name": "DenoiserMicroGrainToggle",
            "default": False,
            "help": "Synthesizes fine, film-like sub-pixel luminance grain on the decoded face to restore photorealistic skin texture.",
        },
        "DenoiserMicroGrainStrengthDecimalSlider": {
            "level": 2,
            "widget_type": "ParameterDecimalSlider",
            "label": "Micro Grain Strength",
            "control_name": "DenoiserMicroGrainStrengthDecimalSlider",
            "min_value": "0.0",
            "max_value": "1.0",
            "default": "0.15",
            "step": 0.01,
            "decimals": 2,
            "parentToggle": "DenoiserMicroGrainToggle",
            "requiredToggleValue": True,
            "help": "Adjusts the amplitude of sub-pixel micro-grain across facial midtones.",
        },
