...
SWAPPER_LAYOUT_DATA: Any = {  # noqa: F811
    "Swapper": {
        ...
        "SecondarySwapperEnableToggle": {
            "level": 1,
            "label": "Secondary Swapper",
            "default": False,
            "help": "Run a second swapper model sequentially and blend the results.",
        },
        ...
        "SecondarySwapperResSelection": {
            "level": 2,
            "label": "Secondary Resolution",
            "options": ["256", "512", "Auto"],
            "default": "Auto",
            "parentToggle": "SecondarySwapperEnableToggle",
            "requiredToggleValue": True,
            "help": "Select the rendering resolution for the secondary swapper model.",
        },
        "SecondarySwapperBlendAmountSlider": {
            ...
            "parentToggle": "SecondarySwapperEnableToggle",
            "requiredToggleValue": True,
            "help": "Blend weight of the secondary model (0 = 100% Primary, 100 = 100% Secondary).",
        },
        "SecondaryTextureOnlyEnableToggle": {
            "level": 2,
            "label": "Texture Only (Anti-Ghosting)",
            "default": False,
            "parentToggle": "SecondarySwapperEnableToggle",
            "requiredToggleValue": True,
            "help": "Applies Frequency Separation to extract the crisp texture from the secondary model while locking the primary model's facial shape, geometry, and color. Eliminates double-face ghosting.",
        },
        "SecondaryTextureRadiusSlider": {
            "level": 3,
            "label": "Frequency Radius",
            "min_value": "1",
            "max_value": "15",
            "default": "4",
            "step": 1,
            "parentToggle": "SecondarySwapperEnableToggle & SecondaryTextureOnlyEnableToggle",
            "requiredToggleValue": True,
            "help": "Separation filter radius. Lower values capture fine micro-pores (close-ups). Higher values capture broader skin texture.",
        },
        "SecondaryTextureCoringDecimalSlider": {
            "level": 3,
            "label": "Edge Coring Limit",
            "min_value": "1.0",
            "max_value": "50.0",
            "default": "14.0",
            "decimals": 1,
            ...
            "parentToggle": "SecondarySwapperEnableToggle & SecondaryTextureOnlyEnableToggle",
            "requiredToggleValue": True,
            "help": "Soft-knee threshold for edge clamping. Prevents high-contrast edges (jawlines, hair, iris) from bleeding while keeping subtle skin pores.",
        },
    ...
    "Swap strength and likeness": {
        ...
        "StrengthAmountSlider": {
            ...
            "parentToggle": "StrengthEnableToggle",
            "requiredToggleValue": True,
            "help": "Adjust iterations for the primary model (100 = 1 pass). 0 turns the primary swap off.",
        },
